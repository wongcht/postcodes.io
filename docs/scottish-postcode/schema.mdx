...
| `user_type`                    | integer         | SPD user type (0 = small user, 1 = large user).                                                | 0             |
...
| `scottish_parliamentary_region`        | string \| null | 2021 Scottish Parliamentary region.                  | "North East Scotland" |
| `scottish_parliamentary_constituency`  | string \| null | 2021 Scottish Parliamentary constituency.            | "Aberdeen Central"    |
