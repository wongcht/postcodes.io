...
| `min_northings`         | integer        | Minimum northing value of the bounding box (Minimum Bounding Rectangle) for roads and settlements.                              | 155850                     |
| `max_eastings`          | integer        | Maximum easting value of the bounding box (Minimum Bounding Rectangle).                                                         | 561984                     |
| `max_northings`         | integer        | Maximum northing value of the bounding box (Minimum Bounding Rectangle).                                                        | 197627                     |
