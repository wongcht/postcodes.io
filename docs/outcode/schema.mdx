...
| `admin_county`   | string[]        | List of administrative counties that contain postcodes within this outcode. Empty when the outcode covers only pseudo-county areas (e.g. unitary authorities, devolved nations). | []                               |
