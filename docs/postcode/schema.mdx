...
| `admin_county`               | string \| null  | The administrative county for this postcode. Null where the postcode falls outside a county-level authority (the underlying GSS code is then a pseudo such as `E99999999`, surfaced under `codes.admin_county`). | ""                                 |
...
| `senedd_constituency`        | string \| null  | The Senedd Cymru (Welsh Parliament) constituency for this postcode. Only applicable to Welsh postcodes; null elsewhere.                   | "Cardiff Central"                  |
| `senedd_constituency_no`     | integer \| null | The Senedd Cymru (Welsh Parliament) constituency number for this postcode. Only applicable to Welsh postcodes; null elsewhere.            | 7                                  |
